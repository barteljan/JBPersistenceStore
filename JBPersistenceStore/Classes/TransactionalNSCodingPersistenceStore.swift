...
public class TransactionalNSCodingPersistenceStore: TypedPersistenceStoreProtocol {
    ...
    public func filter<T>(_: T.Type, includeElement: @escaping (T) -> Bool, completion: @escaping ([T]) -> Void) throws {
    ...
    public func addView<T>(_ viewName: String, groupingBlock _: @escaping ((String, String, T) -> String?), sortingBlock _: @escaping ((String, String, String, T, String, String, T) -> ComparisonResult)) throws {
        throw TransactionalNSCodingPersistenceStoreError.CannotAddViewInTransaction(viewName: viewName)
    }

    public func transaction(transaction _: @escaping (EntityStore) throws -> Void) throws {
